...
Rules: straight column maxi/abaya cuts → fitIntent relaxed or oversized, waist.fit same as chest.fit, hem.fullness regular unless visibly flared. Waisted kameez → semi_fitted or fitted with waist.fit fitted. Do not infer absolute inch measurements.`;
